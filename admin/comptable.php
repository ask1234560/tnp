...
$sql="select name,email from $tbl1_name;" ;
$res  = $conn->query($sql);
...
<div class="header">
  ...
  <div class="header-right">
    <a href="admin.html" style=color:white>Home</a>
      <a href="comp_input.html" style=color:white>Add Company</a>
...
<table class="table table-hover">
   <tr>
    <centre>
    <h1 style="padding-left:50%;">Company List</h1>
        </centre>
    </tr>
    <br>
    <br>
...
<div id="txtHint" style="width: 80%;margin: 10% auto;border: 3px solid #00a3cc;font-size: 20px;">
  ...
  echo "<table> 
    ...
    echo "<tr>"; 
      //echo "<td>" . $row['name'] . "</td>";
      echo "<td>" ."<a href=selected.php?cname=".$row['name'].">". $row['name'] ."</a>". "</td>";
