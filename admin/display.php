...
<body>
  <div class="header">
    ...
    <div class="header-right">
      <a href="logadm.html" style=color:white> Sign Out</a>
      <a href="../user/resume/<?php echo $res3['resume']; ?>" style=color:white>resume</a>
    </div>
  </div>
  ...
  <div class="allign">
    ...
    <div class="photo">
      <img src="../user/images/<?php echo $res['image']; ?>" style="width: 100px;height: 100px;">
    ...
    <div>
      ...
      <form action="papp.php" method="post"> 
        <div class="checkbox checkbox1">
          <label><input type="checkbox" value="1" name="chk">Approve</label>
        </div>
        <button type="Submit" class="btn-primary"  style=margin-bottom:3%>Submit</button>
        <input type="hidden" id="name" name="name" value="<?php echo $res['name']; ?>">
        <input type="hidden" id="admno" name="admno" value="<?php echo $res['admno']; ?>">
        <input type="hidden" id="branch" name="branch" value="<?php echo  $res2['br']; ?>">


        <input type="hidden" id="course" name="course" value="<?php echo $res2['course']; ?>">
        <input type="hidden" id="uc" name="uc" value="<?php echo $res2['uc']; ?>">
        <input type="hidden" id="parr" name="parr" value="<?php echo  $res2['parr']; ?>">
